    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <section className="py-16 md:py-24 px-4 md:px-8 max-w-6xl mx-auto -mt-20 relative z-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
          {[
            ...
            <div key={ticket.name} className="bg-card backdrop-blur-md border border-white/10 p-8 rounded-2xl text-center transition-all hover:bg-white/10">
      ...
      <section className="py-16 md:py-24 px-4 md:px-8 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
        ...
        <div>
          ...
          <div className="aspect-[4/3] md:aspect-square bg-card backdrop-blur-md border border-white/10 rounded-2xl overflow-hidden relative">
