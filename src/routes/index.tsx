    ...
    <div className="min-h-screen bg-background text-foreground font-sans overflow-x-hidden">
      ...
      <section className="py-16 md:py-24 px-4 md:px-8 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
        ...
        <div>
          ...
          <div 
            className="aspect-[4/3] md:aspect-square bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl overflow-hidden relative cursor-pointer group"
            onClick={() => {
              window.open(
                "https://www.google.com/maps/search/?api=1&query=-12.0746355%2C-45.7293565",
                "_blank",
                "noopener,noreferrer"
              );
            }}
          >
            <div className="absolute inset-0 bg-white/5 group-hover:bg-white/10 transition-colors z-10 flex items-center justify-center">
              <div className="size-12 rounded-full bg-primary/20 flex items-center justify-center border border-primary/50 text-primary animate-pulse">
            ...
            <iframe 
              ...
              className="absolute inset-0 w-full h-full border-0 grayscale invert brightness-90 contrast-125 pointer-events-none"
